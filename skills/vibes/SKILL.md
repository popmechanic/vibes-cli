  ...
  <script type="module">
    ...
    function HiddenMenuWrapper({ children, menuContent, showVibesSwitch = true }) {
      ...
      const contentWrapperStyle = {
        ...
        overflowY: "auto",
        borderTopColor: hiddenMenuTheme.colors.menuBg, borderTopWidth: "1px", borderTopStyle: "solid",
        boxShadow: `0 -2px 10px ${hiddenMenuTheme.colors.shadow}`,
      ...
      const toggleButtonStyle = {
        position: "fixed", bottom: hiddenMenuTheme.dimensions.bottomOffset, right: 0,
        zIndex: hiddenMenuTheme.zIndex.toggle, backgroundColor: "transparent", border: "none", cursor: "pointer"
      };
      ...
      return e("div", { style: wrapperStyle },
        ...
        e("div", { style: contentWrapperStyle },
          e("div", { style: innerContentStyle },
            e("div", { style: { width: "100%", height: "100%" } }, children)
          )
        ),
        showVibesSwitch && e("button", { "aria-haspopup": "dialog", "aria-expanded": menuOpen, "aria-controls": "hidden-menu", ref: buttonRef, onClick: () => setMenuOpen(!menuOpen), style: toggleButtonStyle }, e(VibesSwitch, { size: 80 }))
      );
    }

    // === VIBES PANEL (menu content) ===
      ...
      const handleClearData = async () => {
        if (confirm("Clear all data? This cannot be undone.")) {
          ...
          for (const db of databases) {
            if (db.name && db.name.includes(dbName)) indexedDB.deleteDatabase(db.name);
          }
          window.location.reload();
        }
      };
      return e("div", { style: { textAlign: "center", padding: "16px" } },
        e("button", { style: buttonStyle("#3b82f6"), onClick: () => alert("Remix feature!") }, "REMIX"),
        e("button", { style: buttonStyle("#ef4444"), onClick: handleClearData }, "CLEAR DATA"),
        e("button", { style: buttonStyle("#eab308"), onClick: () => window.open("https://vibes.diy", "_blank") }, "VIBES.DIY")
      );
    }
