...
| Understanding skill sequencing | `skills/_base/WORKFLOW.md` |
...
| `skills/_base/WORKFLOW.md` | Canonical workflow sequence graph. Referenced by launch, test, and native skills |
